...
public class GUILibroHarryPotter extends javax.swing.JPanel {
    ...
    public GUILibroHarryPotter(LibroDTO libro, List<LibroDTO> carrito) {
        initComponents();
        this.libro = libro;
    ...
    private void cargarImagen(String rutaImagen) {
        if (rutaImagen != null && !rutaImagen.isEmpty()) {
            try {
                ...
                lblHarryPotterImg.setIcon(imagen);
            } catch (Exception e) {
                System.err.println("Error al cargar la imagen: " + rutaImagen);
                e.printStackTrace();
                lblHarryPotterImg.setText("Imagen no encontrada");
            }
        } else {
            lblHarryPotterImg.setText("Sin imagen");
        }
    }
