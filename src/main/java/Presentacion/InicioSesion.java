            ...
            btnInicioSesion.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    if (correoIngresado.isEmpty() || contraIngresada.isEmpty()) {
                        JOptionPane.showMessageDialog(InicioSesion.this, "Por favor, ingrese correo y contraseña.", "Campos Vacíos", JOptionPane.WARNING_MESSAGE);
                        return;
                    }
                    ...
                    if (usuarioAutenticado != null) {
                        ...
                        if (GestionUsuarios.esAdmin(usuarioAutenticado.getCorreoElectronico())) {
                            ...
                            navegador.navegarAdminGui(InicioSesion.this);
                        } else {
                            System.out.println("Navegando a GUIINICIO para: " + usuarioAutenticado.getCorreoElectronico());
                            navegador.navegarInicio(InicioSesion.this);
                        }
                    } else {
                        JOptionPane.showMessageDialog(InicioSesion.this, "Credenciales incorrectas, inténtelo de nuevo.", "Error de Autenticación", JOptionPane.ERROR_MESSAGE);
                        if (contra != null) {
                            contra.setText("");
                        }
                    }
