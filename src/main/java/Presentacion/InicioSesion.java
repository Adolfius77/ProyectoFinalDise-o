            ...
            btnInicioSesion.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    if (correoIngresado.isEmpty() || contraIngresada.isEmpty()) {
                        JOptionPane.showMessageDialog(InicioSesion.this, "ingrese todos los datos.");
                        return;
                    }
                 
                    boolean inicioDeSesionExitoso = false;
                    for (usuarioDTO usuario : GestionUsuarios.getListaUsuarios()) {
...
//                        JOptionPane.showMessageDialog(InicioSesion.this, "Inicio de sesión exitoso. Bienvenido");
                        navegador.navegarInicio(InicioSesion.this); // Navega a la siguiente pantalla
                    } else {
                        JOptionPane.showMessageDialog(InicioSesion.this, "Credenciales incorrectas, inténtelo de nuevo");
                        contra.setText(""); // Limpia el campo de contraseña
                    }
                }
            });
        }
        if (btnRegistrarse != null) {
            btnRegistrarse.addActionListener(evt -> navegador.navegarRegistro(this));
        }
    }
    ...
    private void btnInicioSesionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInicioSesionActionPerformed
        ...
        if (inicioDeSesionExitoso) {
            JOptionPane.showMessageDialog(this, "inicio de sesion exitoso. Bienvenido");
        } else {
            JOptionPane.showMessageDialog(this, "credenciales incorrectas, intentente de nuevo");
            contra.setText("");
        }
